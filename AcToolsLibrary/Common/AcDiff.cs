...
namespace AcToolsLibrary.Common
{
    ...
    public static string TestHelper(Item []f) {
      ...
      return (ret.ToString());
        ...
        public AcDiffItem[] DiffText(string TextA, string TextB)
        {
        ...
        /// <returns>Returns a array of Items that describe the differences.</returns>
        public static AcDiffItem[] DiffText(string TextA, string TextB, bool trimSpace, bool ignoreSpace, bool ignoreCase)
        {
            // prepare the input-text and convert to comparable numbers.
            Hashtable h = new Hashtable(TextA.Length + TextB.Length);

            // The A-Version of the data (original data) to be compared.
            AcDiffData DataA = new AcDiffData(DiffCodes(TextA, h, trimSpace, ignoreSpace, ignoreCase));

            // The B-Version of the data (modified data) to be compared.
            AcDiffData DataB = new AcDiffData(DiffCodes(TextB, h, trimSpace, ignoreSpace, ignoreCase));
        ...
        /// <returns>Returns a array of Items that describe the differences.</returns>
        public static AcDiffItem[] DiffInt(int[] ArrayA, int[] ArrayB)
        {
            // The A-Version of the data (original data) to be compared.
            AcDiffData DataA = new AcDiffData(ArrayA);

            // The B-Version of the data (modified data) to be compared.
            AcDiffData DataB = new AcDiffData(ArrayB);
        ...
        private static SMSRD SMS(AcDiffData DataA, int LowerA, int UpperA, AcDiffData DataB, int LowerB, int UpperB)
        {
            SMSRD ret;
        ...
        /// <param name="LowerB">lower bound of the actual range in DataB</param>
        /// <param name="UpperB">upper bound of the actual range in DataB (exclusive)</param>
        private static void LCS(AcDiffData DataA, int LowerA, int UpperA, AcDiffData DataB, int LowerB, int UpperB)
        {
        ...
        /// </summary>
        /// dynamic array
        private static AcDiffItem[] CreateDiffs(AcDiffData DataA, AcDiffData DataB)
        {
    ...
    internal class AcDiffData
    {
        ...
        internal AcDiffData(int[] initData)
        {
            data = initData;
