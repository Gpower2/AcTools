...
namespace AcControls.AcRichTextBoxControl
{
    ...
    /// </summary>
    public class AcRichTextBox : RichTextBox
    {
        ...
        private Boolean mFilterAutoComplete = false;

        //Internal use members
        private Boolean mAutoCompleteShown = false;
        private Boolean mParsing = false;
        private Boolean mIgnoreLostFocus = false;
        ...
        private Int32 mMaxUndoRedoSteps = 50;
		...
		/// <param name="m"></param>
		/// <remarks>
		/// Since even when overriding the OnKeyDown method and not calling the base function 
		...
		/// <param name="colors">a hashtable. the key is the color. the value is it's index in the table</param>
