...
class VideoFrame {
  ...
  void AddRef() { InterlockedIncrement((unsigned long *)&refcount); }
  void Release() { if (refcount==1) InterlockedDecrement((unsigned long *) & vfb->refcount); InterlockedDecrement((unsigned long *)&refcount); }
...
//        throw AvisynthError("Internal Error - refcount was more than one!");
  ...
  ~VideoFrame() { InterlockedDecrement((unsigned long *) & vfb->refcount); }
};
...
class IClip {
  ...
  int refcnt;
  void AddRef() { InterlockedIncrement((unsigned long *)&refcnt); }
  void Release() { InterlockedDecrement((unsigned long *)&refcnt); if (!refcnt) delete this; }
public:
  IClip() : refcnt(0) {}
